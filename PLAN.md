...
| **Юзабилити** | 🟡 Хорошая база | Галерея/лайтбокс ✅; карусель, история — в бэклоге |
...
| **Лайтбox** (крупный просмотр, Esc) | ✅ `#image-modal` |
...
| Галерея не восстанавливается из SQLite | 🟡 U2 в USABILITY |
